...
const carta1 = () => {
  return (
    <div>
      <h1 className="font-bold text-2xl md:text-4xl mb-4 md:text-center">CARTA 1. Robarle un día al dios de la guerra</h1>
      <p className="text-xl text-justify">
        Querido Andru: <br/><br/>
        Ahora que tienes el proyecto de disfrutar la tarea de ser maestro,  escribo estas cartas para tí y para las niñas y niños que fueron parte de la experiencia de MARTES DE POESÍA y que hoy, como adultos,  sueñan y trabajan por construir un mundo en el que todos tengamos un  lugar, como aquel por el que pregunta María Elena Walsh en el poema que tu memoria trajo a nuestro encuentro<br/><br/>

        Tal vez  recuerdas que llegué al municipio de El Hobo (Huila) en el año 2003. Un año atrás había ocurrido el secuestro de un senador de la república, mediador de los diálogos de paz que se estaban desarrollando  entre el gobierno nacional y las Farc-Ep.<br/><br/>

        Los estudiantes de la I.E Roberto Suaza Marquínez, a la que tú perteneciste, me llevaron al segundo piso de la planta física  para mostrarme, según ellos, el aeropuerto, porque desde allí podía verse el sector de la carretera nacional en donde hicieron aterrizar el avión para llevar a cabo el secuestro.<br/><br/>

        Debido a este acontecimiento, El Hobo hizo parte de las noticias nacionales e internacionales. Estaba en la mirada del mundo, porque, además de ser un hecho que podía causar la ruptura de los diálogos de paz, había ocurrido de  manera muy cinematográfica.<br/><br/>

        En 1984, este municipio había recibido el apelativo de “Ínsula de paz”, por ser uno de los tres lugares en los que se habían  firmado los acuerdos de paz con el M-19. Sin embargo, en los últimos años había sido objeto de dos tomas guerrilleras, en una de las cuales, la escuela que quedaba en el centro del pueblo y que en ese momento tenía los niños de vacaciones, pasó a ser trinchera del ejército.  Luego el riesgo para los niños se hizo evidente, así que decidieron  que continuaran sus clases en la sede del Bachillerato.<br/><br/>

        Esto, en un país en medio de la guerra, hace parte de la historia cotidiana de sus pobladores. Imágenes en la memoria y en las fotografías que revelan una relación casi naturalizada con hechos violentos o con la amenaza de que ocurran.  Están ahí… sin muchas preguntas. Y también  sin respuestas.<br/><br/>

        Pero ¿por qué empezar con la imagen de los niños y niñas mostrándome un aeropuerto invisible? ¿por qué, con ellos contándome que algunos tenían en sus álbumes familiares  fotos con el avión que forzaron a aterrizar  ese día?, ¿Tú también tenías una? . Asomada a una parte fundamental de la historia de estos niños y sus familias, asomada a sus inquietudes y prioridades, escuchándoles hablar de este acontecimiento como parte de la magia que utilizan cada día para convertir los miedos en posibilidades de ser, me veo preguntándome si hay algo que yo pueda hacer como maestra y como poeta frente a esta realidad.<br/><br/>
        ...
        Un abrazo de albahaca y brisa.<br/><br/>
