            ...
            <div className="min-h-screen flex items-start justify-center bg-[#fffff9] bg-[url('/24.png')] bg-repeat-x bg-cover bg-center">
                <div className="container mx-auto flex flex-col mt-40">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/V5rKClYRY6w?si=1dFNDazdQ5dcGhM-" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                    <h2 className="text-3xl font-bold">Sistematización Martes de Poesía. Clip 1.</h2>
                    <section>
                    ...
                    <h2 className="text-3xl font-bold">Sistematización Martes de Poesía. Clip 2.</h2>
                    <section>
                        <iframe
                    ...
                    <h2 className="text-3xl font-bold">Sistematización Martes de Poesía. Clip 3.</h2>
                    <section>
                        <iframe
                            width="315" height="560"
